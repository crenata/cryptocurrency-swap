                                            ...
                                            <div className="p-4 border-radius-1rem box-shadow-primary bgc-white-opacity-95">
                                                <div className="from-swap">
                                                    <div className="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <p className="m-0 small">Balance : {parseFloat(parseFloat(window.web3.utils.fromWei(web3Context.primaryBalance.toString(), "ether")).toFixed(4))}</p>
                                                    </div>
                                                ...
                                                <div className="to-swap">
                                                    <div className="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <p className="m-0 small">Balance : {parseFloat(parseFloat(window.web3.utils.fromWei(web3Context.bep20Balance.toString(), "ether")).toFixed(4))}</p>
                                                    </div>
                                                    <div className="input-group mt-2">
